    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn-delete-top { font-size:11px; letter-spacing:2px; text-transform:uppercase; color:var(--danger); border:1px solid var(--danger); padding:10px 20px; background:transparent; transition:all 0.3s; font-weight:500; cursor:pointer; }
        ...
        .btn-cancel { background:transparent; border:1px solid var(--border); color:var(--dark); padding:16px 32px; font-family:'Jost',sans-serif; letter-spacing:2px; font-size:11px; text-transform:uppercase; cursor:pointer; flex:1; text-align:center; text-decoration:none; }
